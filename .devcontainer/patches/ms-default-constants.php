...
/**
 * Defines Multisite network constants
 *
 * @since 5.9.1
 */
function ms_network_constants() {
	/**
	 * Set allowed netork ports
	 *
	 * @since 5.9.1
	 */
	if ( ! defined( 'WPMU_ALLOWED_PORTES' ) ) {
		define( 'WPMU_ALLOWED_PORTES', array( ':80', ':443' , ':8080' ) );
	}
}