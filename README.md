...
> Also available at https://wordpress.org/plugins/super-admin-all-sites-menu/ (NOTE: I don't have access to wordpress.org anymore, so as of [release 1.6.8](https://github.com/soderlind/super-admin-all-sites-menu/releases), you can only get updates from GitHub)
