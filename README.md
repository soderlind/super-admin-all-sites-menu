...
- If you activate the Restricted Site Access plugin (included), you'll see a red icon next to the site name. ATM, this only work on the main site due to issues with WordPress Playground.
